...
namespace Blog.Service.Services.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUnitOfWork unitOfWork, IHttpContextAccessor httpContextAccessor, SignInManager<AppUser> signInManager, IMapper mapper, IImageHelper imageHelper, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
